...
public class Main {
    ...
    public Main(){
        ...
        vp.shapes.add(new Triangle(x1T, y1T, x2T, y2T, x3T, y3T, 0, lebar, 0, tinggi));
        ...
        //menunjukkan status clipping
        JTextArea clipping = new JTextArea();
        clipping.setFont(new Font("Serif", Font.PLAIN, 15));
        clipping.setText("Gambar tidak terpotong");
        clipping.setEditable(false);
        clipping.setLineWrap(true);        
        
        //masukan ke dalam panel koordinat
        JPanel koordinat = new JPanel(new GridLayout(10, 1));
        ...
        vp.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                if(switcher == 1){
                    ...
                    Triangle triangle = new Triangle(x1T, y1T, x2T, y2T, x3T, y3T, 0, lebar, 0, tinggi);
                    if(triangle.isClipped()){
                        clipping.setText("Gambar terpotong");
                        vp.shapes.add(triangle);
                    } else if(triangle.isRejected()){
                        clipping.setText("Gambar di luar viewport");
                    } else {
                        clipping.setText("Gambar tidak terpotong");
                        vp.shapes.add(triangle);
                    }                   
